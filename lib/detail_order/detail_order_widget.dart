...
class _DetailOrderWidgetState extends State<DetailOrderWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<OrderRecord>(
      stream: OrderRecord.getDocument(widget.orden!.reference),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  FFButtonWidget(
                                                                    onPressed:
                                                                        () async {
                                                                      await launchURL(
                                                                          'https://api.whatsapp.com/send?phone=${topSectionUserRecord.phoneNumber}');
                                                                    },
                                                                    text:
                                                                        'Contactar',
                                                                    icon: Icon(
                                                          ...
                                                          child: StreamBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    'x${rowSelectedItemsRecord.cantidad.toString()}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium,
                                                                  ),
