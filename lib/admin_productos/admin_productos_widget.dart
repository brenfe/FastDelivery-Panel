...
class AdminProductosWidget extends StatefulWidget {
  const AdminProductosWidget({Key? key}) : super(key: key);

  @override
  _AdminProductosWidgetState createState() => _AdminProductosWidgetState();
}
        ...
        children: [
          wrapWithModel(
            ...
            child: AdminNavWidget(
              navItem: FlutterFlowTheme.of(context).secondaryBackground,
              navItem2: FlutterFlowTheme.of(context).primaryBackground,
              navItem3: FlutterFlowTheme.of(context).secondaryBackground,
              iconColorOne: FlutterFlowTheme.of(context).primaryText,
              iconColorTwo: FlutterFlowTheme.of(context).primary,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('formNuevoProducto');
                          },
                          text: 'Añadir',
